...
BOARD_KERNEL_CMDLINE := dyndbg=&#34;func alloc_contig_dump_pages +p&#34; earlycon=exynos4210,0x10870000 console=ttySAC0,115200 androidboot.console=ttySAC0 printk.devkmsg=on cma_sysfs.experimental=Y cgroup_disable=memory cgroup.memory=nokmem rcupdate.rcu_expedited=1 rcu_nocbs=all rcutree.enable_rcu_lazy swiotlb=noforce disable_dma32=on sysctl.kernel.sched_pelt_multiplier=4 kasan=off ehld.noehld=1 at24.write_timeout=100 log_buf_len=1024K bootconfig
